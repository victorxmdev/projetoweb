...
<div class="container">
    <div class="row mt-4 mb-4">
        <a type="button" class="btn-info btn-sm ml-3" href="<%= pag%>.jsp?funcao=novo">Novo Produto</a>
        ...
        <div class="modal-content">
            ...
            <form id="form" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label >Valor</label>
                        <input value="<%=valor%>" type="text" class="form-control" id="valor" name="valor" placeholder="Valor">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" name="categoria" id="categoria">
                            ...
                            <%
                                ...
                                if (!categoria.equals("")) {
                                    rs = st.executeQuery("SELECT * FROM categorias where id = '" + categoria + "' ");
                                    while (rs.next()) {
                                        nomeCat = rs.getString(2);
                                    }
                                    out.print("<option value='" + categoria + "'>" + nomeCat + "</option>");
